...
bsf STATUS,RB0         ;Go to bank 1 
;Initilize the PORTA 
movlw b'10000'         ;"input/output/output/output/output"
...
bcf STATUS,RB0         ;Goto bank 0 
;Initilaze the PORTS with Initial Values 
movlw b'011111110'     ;Initilize the PORTB with value 0 (Show Num on 7-seg)
movwf PORTB  
movlw b'00101' 
movwf PORTA
